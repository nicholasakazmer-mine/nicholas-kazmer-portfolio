      ...
      <div className="home-top">
        <section className="hero">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">12 years shipping analytics products across 30+ B2B enterprise teams. I design around decisions, prototype in code using Claude Code and Cursor, and measure whether people actually changed how they work.</p>
