...
export default function CaseStudy4({ navigateTo }: Props) {
  const tabs = [
    ...
    },
    {
      ...
      content: (
        <>
          <p style={{ fontSize: '13px', color: 'var(--g500)', lineHeight: 1.7, marginBottom: '16px' }}>Shipped over four quarters, each with a specific hypothesis, a measurable target, and a validation checkpoint before advancing. Q1: navigation restructure around three decision pathways -- hypothesis that simplified IA would reduce "can't find" tickets. Q2: visual unification across all four tools with consistent interaction patterns -- hypothesis that consistent affordances would reduce learning time. Q3: workflow optimization targeting 30-50% fewer clicks per task. Q4: reporting overhaul giving stakeholders export-ready outputs without manual assembly. Every quarter shipped, measured, and informed the next.</p>
          <div className="cs-inline-metrics">
